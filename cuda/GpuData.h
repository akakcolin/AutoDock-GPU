/*
  ...
  Copyright (C) 2019 Computational Structural Biology Center, the Scripps
  Research Institute.
...
static const float MAXREDUCE =
    (float)(1 << (31 - TERMBITS - 4));  // 2^(31 - 10 - 4) = 2^17 = 131072

static const float MAXENERGY =
    FLT_MAX / 100.0;  // Used to cap absurd energies so placeholder energy is
                      // always skipped in sorts
