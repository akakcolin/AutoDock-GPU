...
#define trilin_interpol(cube, weights)                                   \
  (cube[0][0][0] * weights[0][0][0] + cube[1][0][0] * weights[1][0][0] + \
...
void get_trilininterpol_weights(double[][2][2], const double*, const double*,
                                const double*);

void get_trilininterpol_weights_f(float[][2][2], const float*, const float*,
                                  const float*);
...
class LocalRNG {
 ...
 public:
  LocalRNG(uint32_t seed) { init(seed); }
